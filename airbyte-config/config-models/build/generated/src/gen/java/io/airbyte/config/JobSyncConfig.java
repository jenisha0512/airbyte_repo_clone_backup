...
public class JobSyncConfig implements Serializable
{
    ...
    private io.airbyte.config.ResourceRequirements sourceResourceRequirements;
    /**
    ...
    private io.airbyte.config.ResourceRequirements destinationResourceRequirements;
    /**
    ...
    private io.airbyte.config.ResourceRequirements resourceRequirements;
    /**
    ...
    private final static long serialVersionUID = 7516156529198320381L;
     ...
     */
    @JsonProperty("sourceResourceRequirements")
    public io.airbyte.config.ResourceRequirements getSourceResourceRequirements() {
     ...
     */
    @JsonProperty("sourceResourceRequirements")
    public void setSourceResourceRequirements(io.airbyte.config.ResourceRequirements sourceResourceRequirements) {
        this.sourceResourceRequirements = sourceResourceRequirements;
    }

    public JobSyncConfig withSourceResourceRequirements(io.airbyte.config.ResourceRequirements sourceResourceRequirements) {
        this.sourceResourceRequirements = sourceResourceRequirements;
        return this;
    }
     ...
     */
    @JsonProperty("destinationResourceRequirements")
    public io.airbyte.config.ResourceRequirements getDestinationResourceRequirements() {
     ...
     */
    @JsonProperty("destinationResourceRequirements")
    public void setDestinationResourceRequirements(io.airbyte.config.ResourceRequirements destinationResourceRequirements) {
        this.destinationResourceRequirements = destinationResourceRequirements;
    }

    public JobSyncConfig withDestinationResourceRequirements(io.airbyte.config.ResourceRequirements destinationResourceRequirements) {
        this.destinationResourceRequirements = destinationResourceRequirements;
        return this;
    }
     ...
     */
    @JsonProperty("resourceRequirements")
    public io.airbyte.config.ResourceRequirements getResourceRequirements() {
     ...
     */
    @JsonProperty("resourceRequirements")
    public void setResourceRequirements(io.airbyte.config.ResourceRequirements resourceRequirements) {
        this.resourceRequirements = resourceRequirements;
    }

    public JobSyncConfig withResourceRequirements(io.airbyte.config.ResourceRequirements resourceRequirements) {
        this.resourceRequirements = resourceRequirements;
        return this;
    }
