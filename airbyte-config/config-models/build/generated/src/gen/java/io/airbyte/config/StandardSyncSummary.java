...
public class StandardSyncSummary implements Serializable
{
    ...
    private final static long serialVersionUID = 5598660467315012628L;
    ...
    public StandardSyncSummary withStatus(StandardSyncSummary.ReplicationStatus status) {
        this.status = status;
        return this;
    }
    ...
    public enum ReplicationStatus {
        ...
        private final static Map<String, StandardSyncSummary.ReplicationStatus> CONSTANTS = new HashMap<String, StandardSyncSummary.ReplicationStatus>();

        static {
            for (StandardSyncSummary.ReplicationStatus c: values()) {
        ...
        @JsonCreator
        public static StandardSyncSummary.ReplicationStatus fromValue(String value) {
            StandardSyncSummary.ReplicationStatus constant = CONSTANTS.get(value);
            if (constant == null) {
