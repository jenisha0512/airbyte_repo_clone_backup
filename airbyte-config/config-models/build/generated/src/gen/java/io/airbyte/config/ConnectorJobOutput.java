...
public class ConnectorJobOutput implements Serializable
{
    ...
    private ConnectorJobOutput.OutputType outputType;
    /**
    ...
    private final static long serialVersionUID = 4142578956760586841L;
     ...
     */
    @JsonProperty("outputType")
    public ConnectorJobOutput.OutputType getOutputType() {
        return outputType;
    }
     ...
     */
    @JsonProperty("outputType")
    public void setOutputType(ConnectorJobOutput.OutputType outputType) {
        this.outputType = outputType;
    }

    public ConnectorJobOutput withOutputType(ConnectorJobOutput.OutputType outputType) {
        this.outputType = outputType;
        return this;
    }
    ...
    public enum OutputType {
        ...
        private final static Map<String, ConnectorJobOutput.OutputType> CONSTANTS = new HashMap<String, ConnectorJobOutput.OutputType>();

        static {
            for (ConnectorJobOutput.OutputType c: values()) {
        ...
        @JsonCreator
        public static ConnectorJobOutput.OutputType fromValue(String value) {
            ConnectorJobOutput.OutputType constant = CONSTANTS.get(value);
            if (constant == null) {
