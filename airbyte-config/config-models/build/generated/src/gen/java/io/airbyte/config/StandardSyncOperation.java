...
public class StandardSyncOperation implements Serializable
{
    ...
    private StandardSyncOperation.OperatorType operatorType;
    /**
     * OperatorNormalization
     * <p>
    ...
    private final static long serialVersionUID = 2398623300288658180L;
     ...
     */
    @JsonProperty("operatorType")
    public StandardSyncOperation.OperatorType getOperatorType() {
        return operatorType;
    }
     ...
     */
    @JsonProperty("operatorType")
    public void setOperatorType(StandardSyncOperation.OperatorType operatorType) {
        this.operatorType = operatorType;
    }

    public StandardSyncOperation withOperatorType(StandardSyncOperation.OperatorType operatorType) {
        this.operatorType = operatorType;
        return this;
    }
    ...
    public enum OperatorType {
        ...
        private final static Map<String, StandardSyncOperation.OperatorType> CONSTANTS = new HashMap<String, StandardSyncOperation.OperatorType>();

        static {
            for (StandardSyncOperation.OperatorType c: values()) {
        ...
        @JsonCreator
        public static StandardSyncOperation.OperatorType fromValue(String value) {
            StandardSyncOperation.OperatorType constant = CONSTANTS.get(value);
            if (constant == null) {
