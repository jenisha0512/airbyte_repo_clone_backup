...
public class StandardSyncInput implements Serializable
{
    ...
    private final static long serialVersionUID = -3181493215298814282L;
    ...
    public StandardSyncInput withNamespaceDefinition(io.airbyte.config.JobSyncConfig.NamespaceDefinitionType namespaceDefinition) {
        this.namespaceDefinition = namespaceDefinition;
        return this;
    }
