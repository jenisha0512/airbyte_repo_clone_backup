...
public class FailureReason implements Serializable
{
    ...
    private FailureReason.FailureOrigin failureOrigin;
    /**
    ...
    private FailureReason.FailureType failureType;
    /**
     ...
     */
    @JsonProperty("failureOrigin")
    public FailureReason.FailureOrigin getFailureOrigin() {
     ...
     */
    @JsonProperty("failureOrigin")
    public void setFailureOrigin(FailureReason.FailureOrigin failureOrigin) {
        this.failureOrigin = failureOrigin;
    }

    public FailureReason withFailureOrigin(FailureReason.FailureOrigin failureOrigin) {
        this.failureOrigin = failureOrigin;
        return this;
    }
     ...
     */
    @JsonProperty("failureType")
    public FailureReason.FailureType getFailureType() {
        return failureType;
    }
     ...
     */
    @JsonProperty("failureType")
    public void setFailureType(FailureReason.FailureType failureType) {
        this.failureType = failureType;
    }

    public FailureReason withFailureType(FailureReason.FailureType failureType) {
        this.failureType = failureType;
        return this;
    }
    ...
    public enum FailureOrigin {
        ...
        private final static Map<String, FailureReason.FailureOrigin> CONSTANTS = new HashMap<String, FailureReason.FailureOrigin>();

        static {
            for (FailureReason.FailureOrigin c: values()) {
        ...
        @JsonCreator
        public static FailureReason.FailureOrigin fromValue(String value) {
            FailureReason.FailureOrigin constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum FailureType {
        ...
        private final String value;
        private final static Map<String, FailureReason.FailureType> CONSTANTS = new HashMap<String, FailureReason.FailureType>();

        static {
            for (FailureReason.FailureType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static FailureReason.FailureType fromValue(String value) {
            FailureReason.FailureType constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
