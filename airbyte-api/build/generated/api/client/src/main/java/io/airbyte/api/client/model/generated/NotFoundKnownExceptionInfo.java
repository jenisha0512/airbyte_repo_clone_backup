 ...
 */
@JsonPropertyOrder({
  NotFoundKnownExceptionInfo.JSON_PROPERTY_ID,
  NotFoundKnownExceptionInfo.JSON_PROPERTY_MESSAGE,
  NotFoundKnownExceptionInfo.JSON_PROPERTY_EXCEPTION_CLASS_NAME,
  NotFoundKnownExceptionInfo.JSON_PROPERTY_EXCEPTION_STACK,
  NotFoundKnownExceptionInfo.JSON_PROPERTY_ROOT_CAUSE_EXCEPTION_CLASS_NAME,
  NotFoundKnownExceptionInfo.JSON_PROPERTY_ROOT_CAUSE_EXCEPTION_STACK
})
...
public class NotFoundKnownExceptionInfo {
  ...
  **/
  ...
  /**
   * Return true if this NotFoundKnownExceptionInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, notFoundKnownExceptionInfo.id) &&
        Objects.equals(this.message, notFoundKnownExceptionInfo.message) &&
        Objects.equals(this.exceptionClassName, notFoundKnownExceptionInfo.exceptionClassName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, message, exceptionClassName, exceptionStack, rootCauseExceptionClassName, rootCauseExceptionStack);
  }
