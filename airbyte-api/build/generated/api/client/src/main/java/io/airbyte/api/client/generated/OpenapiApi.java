...
public class OpenapiApi {
  ...
  public File getOpenApiSpec() throws ApiException {
    ApiResponse<File> localVarResponse = getOpenApiSpecWithHttpInfo();
  ...
  public ApiResponse<File> getOpenApiSpecWithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getOpenApiSpecRequestBuilder();
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getOpenApiSpec", localVarResponse);
        }
  ...
  private HttpRequest.Builder getOpenApiSpecRequestBuilder() throws ApiException {
