...
public class DestinationDefinitionSpecificationApi {
  ...
  public DestinationDefinitionSpecificationRead getDestinationDefinitionSpecification(DestinationDefinitionIdWithWorkspaceId destinationDefinitionIdWithWorkspaceId) throws ApiException {
    ApiResponse<DestinationDefinitionSpecificationRead> localVarResponse = getDestinationDefinitionSpecificationWithHttpInfo(destinationDefinitionIdWithWorkspaceId);
  ...
  public ApiResponse<DestinationDefinitionSpecificationRead> getDestinationDefinitionSpecificationWithHttpInfo(DestinationDefinitionIdWithWorkspaceId destinationDefinitionIdWithWorkspaceId) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getDestinationDefinitionSpecificationRequestBuilder(destinationDefinitionIdWithWorkspaceId);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getDestinationDefinitionSpecification", localVarResponse);
        }
        return new ApiResponse<DestinationDefinitionSpecificationRead>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<DestinationDefinitionSpecificationRead>() {}) // closes the InputStream
  ...
  private HttpRequest.Builder getDestinationDefinitionSpecificationRequestBuilder(DestinationDefinitionIdWithWorkspaceId destinationDefinitionIdWithWorkspaceId) throws ApiException {
    ...
    if (destinationDefinitionIdWithWorkspaceId == null) {
      throw new ApiException(400, "Missing the required parameter 'destinationDefinitionIdWithWorkspaceId' when calling getDestinationDefinitionSpecification");
    }
