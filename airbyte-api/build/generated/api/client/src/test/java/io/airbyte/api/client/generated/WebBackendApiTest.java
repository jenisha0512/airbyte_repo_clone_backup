...
public class WebBackendApiTest {
    ...
    public void getStateTypeTest() throws ApiException {
        ...
        api.getStateType(connectionIdRequestBody);
    ...
    public void webBackendCheckUpdatesTest() throws ApiException {
        WebBackendCheckUpdatesRead response = 
        api.webBackendCheckUpdates();
    ...
    public void webBackendCreateConnectionTest() throws ApiException {
        ...
        WebBackendConnectionRead response = 
        api.webBackendCreateConnection(webBackendConnectionCreate);
    ...
    public void webBackendGetConnectionTest() throws ApiException {
        ...
        WebBackendConnectionRead response = 
        api.webBackendGetConnection(webBackendConnectionRequestBody);
    ...
    public void webBackendGetWorkspaceStateTest() throws ApiException {
        ...
        WebBackendWorkspaceStateResult response = 
        api.webBackendGetWorkspaceState(webBackendWorkspaceState);
    ...
    public void webBackendListConnectionsForWorkspaceTest() throws ApiException {
        ...
        WebBackendConnectionReadList response = 
        api.webBackendListConnectionsForWorkspace(webBackendConnectionListRequestBody);
    ...
    public void webBackendListGeographiesTest() throws ApiException {
        WebBackendGeographiesListResult response = 
        api.webBackendListGeographies();
    ...
    public void webBackendUpdateConnectionTest() throws ApiException {
        ...
        WebBackendConnectionRead response = 
        api.webBackendUpdateConnection(webBackendConnectionUpdate);
