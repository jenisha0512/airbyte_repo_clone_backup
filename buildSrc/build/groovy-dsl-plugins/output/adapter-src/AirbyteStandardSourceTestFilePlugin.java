...
/**
 * Precompiled airbyte-standard-source-test-file script plugin.
 **/
public class AirbyteStandardSourceTestFilePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AirbyteStandardSourceTestFile").asSubclass(BasicScript.class);
