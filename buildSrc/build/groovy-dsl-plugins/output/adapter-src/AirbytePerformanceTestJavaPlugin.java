...
/**
 * Precompiled airbyte-performance-test-java script plugin.
 **/
public class AirbytePerformanceTestJavaPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AirbytePerformanceTestJava").asSubclass(BasicScript.class);
