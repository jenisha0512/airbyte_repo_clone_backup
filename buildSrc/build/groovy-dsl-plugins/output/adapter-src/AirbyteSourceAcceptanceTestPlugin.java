...
/**
 * Precompiled airbyte-source-acceptance-test script plugin.
 **/
public class AirbyteSourceAcceptanceTestPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AirbyteSourceAcceptanceTest").asSubclass(BasicScript.class);
