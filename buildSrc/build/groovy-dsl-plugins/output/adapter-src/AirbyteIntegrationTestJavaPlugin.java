...
/**
 * Precompiled airbyte-integration-test-java script plugin.
 **/
public class AirbyteIntegrationTestJavaPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AirbyteIntegrationTestJava").asSubclass(BasicScript.class);
