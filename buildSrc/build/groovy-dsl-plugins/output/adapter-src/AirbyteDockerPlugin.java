...
/**
 * Precompiled airbyte-docker script plugin.
 **/
public class AirbyteDockerPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AirbyteDocker").asSubclass(BasicScript.class);
